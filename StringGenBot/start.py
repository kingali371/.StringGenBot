...
بواسطـة : [ٌٍꪎ.ًٍᘔٍᥱᎥٍَꪀ](tg://user?id=1355571767) !""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(text="🙄 لاستخراج جلسه 🙄", callback_data="generate")
                ],
                [
                    InlineKeyboardButton("❣️ قناه السورس ❣️", url="https://t.me/pp_g3"),
                    InlineKeyboardButton("🥀 ᴅᴇᴠᴇʟᴏᴩᴇʀ 🥀", user_id=1355571767)
                ]
            ]
        ),

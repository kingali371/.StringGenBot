...
ask_ques = "**» ⚡¦يـمكنك استـخـراج الـتـالـي\n♻️¦تيرمـكـس تليثون للحسـابـات🏂\n♻️¦تيرمـكـس تليثون للحسـابـات🏂\n♻️¦تيرمـكـس تليثون للبوتــات🤖\n🎧¦بايـروجـرام مـيوزك للحسابات🙋🏼‍♂️\n🗽¦بايـروجـرام مـيوزك احدث اصدار🎊\n🎧¦بايـروجـرام مـيوزك للبوتات🤖\n- يعمـل هـذا البـوت لمساعدتـك بطريقـة سهلـه للحصـول على كـود تيرمكـس لتشغيل تلـيثون والبايروجرام لتشغيل سـورس اغــاني تم انشـاء هـذا البـوتɢ :**"
...
gen_button = [
    [
        InlineKeyboardButton(text="🙄 لاستخراج الجلسه 🙄", callback_data="generate")
    ]
]
...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    user_id = msg.chat.id
    api_id_msg = await bot.ask(user_id, "🎮حسنـا قم بأرسال الـ API_HASH\n\nاضغط /skip عشان تكمل بالموجدين", filters=filters.text)
